...
const Skills = () => {
  ...
  useEffect(()=>{
    const fetchSkills=async()=>{
        try {
            const {data} = await axios.get("https://dynamic-portfolio-backend-essm.onrender.com/api/v1/skill/getall",{withCredentials:true});
  ...
  return (
    <div>
      <h1 className='flex gap-7 items-center overflow-x-hidden text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px] mb-[50px] font-extrabold'>Skills</h1>
