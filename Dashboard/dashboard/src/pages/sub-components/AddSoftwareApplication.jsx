    ...
    <>
     <div className="flex justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14">
        ...
        <div className="col-span-full">
          <label  className="block text-sm font-medium leading-6 text-gray-900">Software SVG</label>
            ...
            <div className="text-center">
              ...
              <div className="mt-4 flex text-sm leading-6 text-gray-600">
                <label  className="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                  ...
                  <Input id="file-upload" name="file-upload" type="file" className="sr-only" onChange={handleSvg}></Input>
                </label>
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            {!loading ? (
              ...
              >
               ...
               <SpecialLoadingButton content={"Adding New Software"} />
            )}
          </div>
        </form>
      </div>
